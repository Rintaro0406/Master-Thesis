...
from tensorflow.keras import regularizers  # added 25.3.2023
...
class Chebyshev(Model):
    ...
    def __init__(self, L, K, Fout=None, initializer=None, activation=None, use_bias=False,
        ...
        self.kernel_regularizer = regularizers.get(kernel_regularizer)        # added 25.3.2023
        self.kwargs = kwargs
    ...
    def build(self, input_shape):
        ...
        self.kernel = self.add_weight("kernel",shape=[self.K * Fin, Fout],
                                      regularizer=self.kernel_regularizer)    # added 25.3.2023
